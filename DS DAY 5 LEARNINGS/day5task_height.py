# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 22:09:23 2022
...
Code Challenge
  Filename: 
    height.py
  Problem Statement: Find the height of SAM by finding average of height of Mary and Isla.
...
"""
  ...
  if height_count > 0:
      ...
      print (average_height)
#try map reduce and filter
people = [{'name': 'Mary', 'height': 160},
            {'name': 'Isla', 'height': 80},
            {'name': 'Sam'}]

def average_height (a) :
    return (height_total/height_count)
      
print(list(map(average_height,people)))
